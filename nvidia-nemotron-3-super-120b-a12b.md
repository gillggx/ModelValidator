# nvidia/nemotron-3-super-120b-a12b — Agentic AI + Code Gen 驗證報告 (V16)
...
- **原因**：`Error code: 404 - {'error': {'message': 'No endpoints found for nvidia/nemotron-3-super-120b-a12b.', 'code': 404}, 'user_id': 'user_39s2oWTwaGs3KWVn9lQBM00DEYY'}`
